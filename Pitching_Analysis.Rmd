...
### How often do umpires make the right ball / strike calls? Are certain pitchers (or in-game situations) more prone to inaccurate calls?

To start with, we'll have to define an "objective strike zone" based on the 
Statcast data. I'll propose the following rules /assumptions:

- The width (horizontal dimension) of the strike zone is the same as the width
of home plate (17 inches)
...
- If any part of a baseball is in the strike zone at the time it crosses home
plate, it should be called a strike
